...
const ManageAntibioticCategory = () => {

    const items = [
        { title: 'Medical', href: '/admin/medical' },
        { title: 'Manage Antibiotic Category', href: '#' },
    ].map((item, index) => (
    ...
    const deleteCategory = () => {
        ...
        axios.post('https://abcdmedical.herokuapp.com/api/v1/categories/antibiotic/delete', category ,config)
        .then (res => {
    ...
    return <>
        ...
        <Sidebar pageName="Manage Antibiotic Category">
...
export default ManageAntibioticCategory
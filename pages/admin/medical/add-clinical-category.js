...
const AddClinicalCategory = () => {

    const items = [
        { title: 'Medical', href: '/admin/medical' },
        { title: 'Add Clinical Category', href: '#' },
    ].map((item, index) => (
    ...
    const handleSubmit = (values) => {
        ...
        axios.post('https://abcdmedical.herokuapp.com/api/v1/categories/clinical/create', category ,config)
        .then(res => {
...

                    {
                        ...
                        <>
...

                            {
                                ...
                                <Select
                                    my="30px"
                                    label="Clinical Parent Category"
...
export default AddClinicalCategory
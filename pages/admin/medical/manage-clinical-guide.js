...
const ManageClinicalGuide = () => {

    const items = [
        { title: 'Medical', href: '/admin/medical' },
        { title: 'Manage Clinical Guide', href: '#' },
    ].map((item, index) => (
    ...
    const getGuide = () => {
        ...
        axios.get('https://abcdmedical.herokuapp.com/api/v1/diagnosis/clinical/get', config)
        .then (res => {
            if (res.status === 200){
                setGuide(res.data)
                setStatus('success')
    ...
    const deleteGuide = () => {
        ...
        axios.post('https://abcdmedical.herokuapp.com/api/v1/diagnosis/clinical/delete', guide ,config)
        .then (res => {
    ...
    const updateGuide = (value) => {
        ...
        axios.post('https://abcdmedical.herokuapp.com/api/v1/diagnosis/clinical/update', value ,config)
        .then (res => {
            if (res.data.message === "success"){
    ...
    return <>
        ...
        <Sidebar pageName="Manage Clinical Guide">
...
export default ManageClinicalGuide